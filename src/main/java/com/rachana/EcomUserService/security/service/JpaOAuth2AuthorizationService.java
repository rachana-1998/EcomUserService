package com.rachana.EcomUserService.security.service;

import com.rachana.EcomUserService.security.model.Authorization;
import org.springframework.stereotype.Component;


// com. rachana. EcomUserService. security. repository. AuthorizationRepository'
...
import com.rachana.EcomUserService.security.repository.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findById(String id) {
        ...
        return this.authorizationRepository.findById(id).map(entity->this.toObject(entity)).orElse(null);
